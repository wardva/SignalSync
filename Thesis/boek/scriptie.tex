...
\hyphenation{tijd-as audio-stream real-time TeensyDAQ} % splitsing van woorden
...
% omgeving om alles in \texttt te schrijven
...
\hypersetup {
	...
	pdftitle = {Realtime signaal synchronisatie	met acoustic fingerprinting},
...
\include{h1-inleiding}
\include{h2-methode}
\include{h3-implementatie}
\include{h4-evaluatie}
\include{h5-conclusie}
