...
Streams kunnen verschillende manieren worden ingelezen. De data kan afkomstig zijn van een microfoon, een bestand of van een virtuele patchkabel uit Max/MSP. De TarsosDSP bibliotheek bevat de klasse \texttt{AudioDispatcher} die het inlezen van data afkomstig van een microfoon of bestand verzorgt en een abstracte interface aanbiedt voor verdere verwerking. Het inlezen van data uit Max/MSP gebeurt op een heel andere manier. Daarop wordt er nog een extra abstractie voorzien die toelaat om zowel \texttt{AudioDispatcher} als Max/MSP streams op dezelfde manier aan te spreken.
