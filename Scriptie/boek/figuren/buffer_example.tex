...
after end axis/.code={
	...
	\draw[black,<->] (axis cs:180,0.2) -- (axis cs:190,0.2)	node [pos=0.5,above,font=\scriptsize] {buffer $i$};
	
	\draw[black,<->] (axis cs:185,0.3) -- (axis cs:195,0.3)	node [pos=0.5,above,font=\scriptsize] {buffer $i+1$};
}]
